...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = module.exports || {}) &&
      (module.exports.DAWG = factory(module.exports))
    : typeof define === "function" && define.amd
    ? define("Az.DAWG", ["Az"], factory)
...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = module.exports || {}) &&
      (module.exports.Morph = factory(module.exports))
    : typeof define === "function" && define.amd
    ? define("Az.Morph", ["Az", "Az.DAWG"], factory)
   ...
   *
   * @param {Tag|Parse|string|number} [tag] Тег или другой разбор слова, с которым следует
   *  согласовать данный.
  ...
  Morph.init = function (path, callback) {
    ...
    loading++;
    Az.load(
      path + "/gramtab-opencorpora-int.json",
      "json",
      function (err, json) {
        if (err) {
          callback(err);
    ...
    loading++;
    Az.load(
      path + "/gramtab-opencorpora-ext.json",
      "json",
      function (err, json) {
        if (err) {
          callback(err);
...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = module.exports || {}) &&
      (module.exports.Syntax = factory(module.exports))
    : typeof define === "function" && define.amd
    ? define("Az.Syntax", ["Az"], factory)
...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = module.exports || {}) &&
      (module.exports.Tokens = factory())
    : typeof define === "function" && define.amd
    ? define("Az.Tokens", ["Az"], factory)
